const o=$(".siteList"),e=o.find("li.last"),l=localStorage.getItem("x"),s=JSON.parse(l);window.hashMap=s||[{logo:"A",url:"https://www.acfun.cn"},{logo:"B",url:"https://www.bilibili.com"}];const t=o=>o.replace("https://","").replace("http://","").replace("www.","").replace(/\/.*/,""),a=()=>{o.find("li:not(.last)").remove(),hashMap.forEach((o,l)=>{let s=$(`<li>
            <div class="site">
...
//# sourceMappingURL=index.28cd3eae.js.map
